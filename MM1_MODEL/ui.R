          ...
          (tags$a(href="#", class="brand-logo", "Shiny ",
            ...
            (tags$img(class="img-logo", height="25px", witdh="30px", src="https://d33wubrfki0l68.cloudfront.net/62bcc8535a06077094ca3c29c383e37ad7334311/a263f/assets/img/logo.svg",
                tags$ul(class="side-nav", id="mobile-demo",
                    tags$li(class="right",
                        tags$a(href="https://github.com/EmilioBG1997", "GitHub - Emilio Barrera", class="gray-text",
          ...
          (tags$div(class="col s12 m8",
            (tags$div(class="card card-background",
              (tags$div(class="card-content",
                ...
                (tags$p("The probability of the system being on a lazy state: ", (tags$span(id="lazy")))),
                (tags$p("The sum of the probabilities from 0 to n is", tags$span(id="sum-probs"))),
                (tags$p("The probabilities of having more than n clients in the system", tags$span(id="1-probs")))
              ))))))),
